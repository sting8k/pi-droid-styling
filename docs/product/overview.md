...
- Claude Code-style rounded welcome banner with the full theme-gradient Pi logo plus loaded resources display; What's new is filled from the installed Pi changelog for the current version.
